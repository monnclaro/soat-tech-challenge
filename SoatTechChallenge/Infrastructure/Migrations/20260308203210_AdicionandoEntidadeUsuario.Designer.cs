...
namespace SoatTechChallenge.Infrastructure.Migrations
{
    ...
    [Migration("20260308203210_AdicionandoEntidadeUsuario")]
    partial class AdicionandoEntidadeUsuario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoatTechChallenge.Domain.OrdensServico.Produtos.OrdemServicoProduto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SoatTechChallenge.Domain.Usuarios.Roles.UsuarioRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SoatTechChallenge.Domain.OrdensServico.Produtos.OrdemServicoProduto", b =>
                {
                    b.HasOne("SoatTechChallenge.Domain.OrdensServico.OrdemServico", null)
                        .WithMany("Produtos")
            ...
            modelBuilder.Entity("SoatTechChallenge.Domain.Usuarios.Roles.UsuarioRole", b =>
                {
                    b.HasOne("SoatTechChallenge.Domain.Usuarios.Usuario", null)
                        .WithMany("Roles")
