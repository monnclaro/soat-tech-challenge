...
|---|---|
| API Gateway, AuthFunction | [soat-tech-challenge-lambda](https://github.com/monnclaro/soat-tech-challenge-lambda) |
...
- RFCs: [rfcs/](./rfcs)
- ADRs: [adr/](./adr) — em especial [0008](./adr/0008-prioridade-de-custo-aws-academy.md) (custo/AWS Academy) e [0009](./adr/0009-sem-lambda-authorizer.md) (sem Lambda Authorizer)
